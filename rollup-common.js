...
const PACKAGE_CLASS_PREFIXES = {
  ...
  'lit-element': '_$D',
  '@lit/task': '_$E',
  '@lit/reactive-element': '_$F',
  '@lit-labs/motion': '_$G',
  '@lit-labs/react': '_$H',
  '@lit-labs/scoped-registry-mixin': '_$I',
  '@lit-labs/ssr-client': '_$J',
  '@lit-labs/task': '_$K',
  '@lit-labs/router': '_$L',
  '@lit-labs/observers': '_$M',
  '@lit-labs/context': '_$N',
  '@lit-labs/vue-utils': '_$O',
  '@lit-labs/preact-signals': '_$P',
};
