...
export abstract class ReactiveElement
  // In the browser, we simply extend HTMLElement.
  //
  // In Node, we extend either the global HTMLElement if one is defined, or
  // the HTMLElement shim that has been imported from the
  // @lit-labs/ssr-dom-shim package (see note at the top of this file about
  // how this import is generated by Rollup). Note we can't simply "extend
  // HTMLElement" in Node here, because the "HTMLElement" variable has been
  // shadowed by said import so no longer refers to the global.
  extends (NODE_MODE ? global.HTMLElement ?? HTMLElement : HTMLElement)
