...
export const _Σ = {
  ...
  _BooleanAttributePart: BooleanAttributePart as AttributePartConstructor,
  _EventPart: EventPart as AttributePartConstructor,
  _PropertyPart: PropertyPart as AttributePartConstructor,
