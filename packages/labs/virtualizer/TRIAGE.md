...
Last updated: 2026-04-10 (added #5296)
...
| #5296 | Default keyFunction breaks rendering with non-unique scalar items | rendering, directive | #5279 (draft) | `043703e3` | `08d4d672` | `defaultKeyFunction` was `(item) => item`, producing duplicate keys for lit-html's `repeat` whenever items contained repeated scalar values. Caused malformed DOM and off-by-one child counts during rapid scroll, eventually throwing `TypeError: Cannot read properties of null (reading 'nextSibling')` from `ChildPart._$clear`. Changed default to `(_item, index) => index` (matches lit-html's own `repeat` default). |
...
| #5279 | Bug fixes                                     | `virtualizer/css-direction--bug-fixes`                   | #4767, #4789, #4827, #4670, #4922, #4982, #4693, #5006, #5285, #5286, #5290, #5293, #5296 | Draft                 |
...
4377, 4505, 4540, 4670, 4693, 4767, 4789, 4827, 4833, 4839, 4922, 4945, 4982, 5006, 5008, 5212, 5281, 5282, 5285, 5286, 5290, 5291, 5293, 5294, 5295, 5296
