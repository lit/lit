...
| Flag                 | Description                                                                                                                                                      |
| -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--skip-permissions` | Skip asking for permission to install commands that are not installed. This is a global flag, and is useful for AI clients to automate the installation process. |
