...
for (const lang of languages) {
  suite(`LitElement property tests (${lang})`, () => {
    ...
    test('non-decorated fields are not reactive', () => {
    ...
    test('constructor-assigned non-decorated field', () => {
    ...
    test('accessor pair', () => {
      ...
      assert.notEqual(property.readonly, true);
      assert.equal(property.type?.text, 'number');
      assert.equal(property.type?.references.length, 0);
    });

    test('string property with no options', () => {
    ...
    test('number property with no options', () => {
    ...
    test('string property with type', () => {
    ...
    test('number property with type', () => {
    ...
    test('boolean property with type', () => {
    ...
    test('property typed with local class', () => {
    ...
    test('property typed with imported class', () => {
    ...
    test('property typed with global class', () => {
    ...
    test('property typed with union', () => {
    ...
    test('property defined in static properties block', () => {
    ...
    test('method with an overloaded signature', () => {
    ...
    test('property with an unsupported name type', () => {
      ...
      assert.strictEqual(reactiveProperty, undefined);
    });
  });
}
