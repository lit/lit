...
if (DEV_MODE) {
  (_a = ReactiveElement.disableWarning) === null || _a === void 0
    ? void 0
    : _a.call(ReactiveElement, 'change-in-update');
}
suite('Task', () => {
  let container;
  const defineTestElement = (config) => {
    class A extends ReactiveElement {
      ...
      update(changedProperties) {
        ...
        this.taskValue =
          (_a = this.task.value) !== null && _a !== void 0
            ? _a
            : this.task.error;
        this.task.render({
    ...
    __decorate([property()], A.prototype, 'a', void 0);
    __decorate([property()], A.prototype, 'b', void 0);
    __decorate([property()], A.prototype, 'c', void 0);
  ...
  test('task functions can return initial state', async () => {
    ...
    __decorate([property()], TestEl.prototype, 'state', void 0);
