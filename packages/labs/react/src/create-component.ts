 ...
 *
 * @param params The React module, typically imported from the `react` npm
 * package.
 * @param params.React The React module, typically imported from the `react` npm
 * package.
 * @param params.tagName The custom element tag name registered via
 * `customElements.define`.
 * @param params.elementClass The custom element class registered via
 * `customElements.define`.
 * @param params.events An object listing events to which the component can listen. The
 ...
 * @param params.displayName A React component display name, used in debugging
...
export function createComponent<
  ...
  E extends EventNames = {}
>(
  ReactOrOptions: typeof window.React | Params<I, E> = window.React,
  tagName?: string,
  elementClass?: Constructor<I>,
  events?: E,
  displayName?: string
