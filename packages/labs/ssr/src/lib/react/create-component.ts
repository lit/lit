...
// import { hydrateShadowRoots } from 'template-shadowroot';
...
export const createComponent = <T extends HTMLElement>(
  ...
  return (class extends Component {
     ...
     */
    componentDidMount() {
      // hydrateShadowRoots(this.element);
      this.updateElement();
      if (this.element.hasAttribute('defer-hydration')) {
        this.element.removeAttribute('defer-hydration');
      }
    }
