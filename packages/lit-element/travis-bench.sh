#!/usr/bin/env bash
# Run the lit-element benchmarks using Travis environment variables.
...
BENCHMARK="shack=./node_modules/lit-element-benchmarks/shack"
...
npx tach $BENCHMARK \
  ...
  --package-version=this=lit-element@github:${THIS} \
  --package-version=parent=lit-element@github:${PARENT} \
  --package-version=published=lit-element@* \
