# UpdatingElement 1.0 Pre-release
...
This is a major version pre-release of UpdatingElement 1.0. This package
...
UpdatingElement is a low level base class for creating custom elements that
render content to shadowRoot via a user implemented method. It adds API to help
manage element properties and attributes. UpdatingElement reacts to changes in
...
export class MyElement extends UpdatingElement {
...
standard currently available in [TypeScript](https://www.typescriptlang.org/) or [Babel](https://babeljs.io/docs/en/babel-plugin-proposal-decorators). UpdatingElement also supports a [vanilla JavaScript method](https://lit-element.polymer-project.org/guide/properties#declare) of declaring reactive properties.
...
updating-element includes a development mode which adds additional checks that are
