...
import {
  ...
  EVENT_STRATEGY,
  ASCEND_STRATEGY,
} from 'lit-labs/controllers/context.js';
...
(async () => {
  ...
  class XThing extends UpdatingElement {
    ...
    controller = new context.consumer(this);
  ...
  class XApp extends UpdatingElement {
    ...
    context = new context.provider(this);

    constructor() {
      super();
      this.context.provideAll();
      this.context.value = 'H: 0: 0';
    }
